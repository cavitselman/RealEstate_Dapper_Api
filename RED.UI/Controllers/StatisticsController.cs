...
namespace RED.UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:44383/api/Statistics/ActiveCategoryCount");
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44383/api/Statistics/ActiveEmployeeCount");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44383/api/Statistics/ApartmentCount");
            ...
            var responseMessage6 = await client6.GetAsync("https://localhost:44383/api/Statistics/AverageRoomCount");
            ...
            var responseMessage7 = await client7.GetAsync("https://localhost:44383/api/Statistics/CategoryCount");
            ...
            var responseMessage10 = await client10.GetAsync("https://localhost:44383/api/Statistics/DifferentCityCount");
            ...
            var responseMessage13 = await client13.GetAsync("https://localhost:44383/api/Statistics/NewestBuildingYear");
            ...
            var responseMessage14 = await client14.GetAsync("https://localhost:44383/api/Statistics/OldestBuildingYear");
            ...
            var responseMessage15 = await client15.GetAsync("https://localhost:44383/api/Statistics/PassiveCategoryCount");
